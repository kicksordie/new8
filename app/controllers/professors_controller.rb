class ProfessorsController < ApplicationController
  ...
  def create
    ...
    @professor = @school.professors.create(professor_params)
    if @professor.save
      redirect_to @professor, notice: 'Professor was successfully created.'
    else
      render :new
    end
    redirect_to article_path(@school)
  end
  ...
  private
    ...
    def professor_params
      params.require(:professor).permit(:name, :department, :school_id, :school_name)
    end
end
