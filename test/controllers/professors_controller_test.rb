...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { department: @professor.department, name: @professor.name, school_id: @professor.school_id, school_name: @professor.school_name }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { department: @professor.department, name: @professor.name, school_id: @professor.school_id, school_name: @professor.school_name }
    assert_redirected_to professor_path(assigns(:professor))
  end
